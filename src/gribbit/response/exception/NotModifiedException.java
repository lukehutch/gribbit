...
public class NotModifiedException extends RequestHandlingException {
    /**
     * This exception is thrown when a user tries to access a resource that hasn't changed. Takes the last modified time
     * of the resource that has not been modified since the timestamp of the version stored in the browser's cache.
     */
