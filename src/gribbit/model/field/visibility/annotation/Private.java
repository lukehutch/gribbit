 ...
 * the POST request), or from being rendered as a template parameter. Prevents the user from ever seeing the value in
 * the data model, and from changing the value.
 */
