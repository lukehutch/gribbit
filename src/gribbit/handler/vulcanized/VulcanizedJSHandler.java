...
public class VulcanizedJSHandler extends RestHandler.AuthNotRequired {
    public void get() throws Exception {
        ...
        if (req.cachedVersionIsOlderThan(resourcesLoadedEpochSecond)) {
            ...
            res.setContentUnsafe(Unpooled.wrappedBuffer(GribbitServer.siteResources.getVulcanizedJSBytes()), "application/javascript;charset=utf-8");
        } else {
            // Classpath elements have not changed since last fetched by browser. Call the Not Modified handler. 
