 ...
 * 
 * N.B. Netty changes the URI of the request to "/bad-request" if the HTTP request was malformed, so we need to handle this route anyway. We catch that case automatically here by
